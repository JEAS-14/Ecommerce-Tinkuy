...
// Definimos la ruta base para todos los enlaces HTML (css, js, img)
$base_url = "/Ecommerce-Tinkuy/public";
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <?php 
    // Define la página actual para que el navbar la resalte
        ...
        <div class="bg-dark text-white p-5 rounded shadow">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="/Ecommerce-Tinkuy/public/img/muchastelas.jpeg" alt="Artesanas trabajando" class="img-fluid rounded shadow">
                </div>
                <div class="col-md-6">
    ...
    <section class="container my-5">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="/Ecommerce-Tinkuy/public/img/trabajadores.jpeg" alt="Proceso de trabajo artesanal" class="img-fluid rounded shadow">
            </div>
            <div class="col-md-6">
                <p>
