...
<body>
    ...
    <!-- Sección Principal: Sobre Tinkuy -->
        ...
        <div class="bg-dark text-white p-5 rounded shadow">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="">
                        <p>
                            En Tinkuy, nos inspiramos en el arte ancestral de los pueblos andinos, donde cada prenda
                            tiene
                            una
                            historia que contar. Comenzamos con un pequeño grupo de mujeres de la cárcel de Jauja, a
                            quienes
                            les
                            enseñamos las técnicas de tejido con lana de alpaca bebé, un material suave y de gran
                            calidad.
                            Con el
                            tiempo, nuestro trabajo fue creciendo, integrando más comunidades rurales de diferentes
                            regiones
                            de Perú.
                            Hoy en día, somos una red de apoyo que proporciona empleo y nuevas oportunidades para
                            cientos de
                            mujeres.
                        </p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    ...
                    más
                    vulnerables. Queremos ser un puente entre la tradición artesanal y el mercado global, promoviendo la
                    sostenibilidad, la inclusión social y el comercio justo. Cada prenda que elaboramos representa el
                    esfuerzo,
                    la pasión y la dedicación de las personas que las crean.
                </p>
            </div>
            <div class="col-md-6">
                ...
                <p>
                    ...
                    cultural.
                    Queremos seguir creciendo para ofrecer más oportunidades a más artesanas y hacer de Tinkuy un
                    referente
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <p>
                    ...
                    justicia
                    social. Colaboramos con artesanas de diversas regiones del Perú, brindándoles materiales de alta
                    calidad
                    y herramientas para que puedan crear piezas únicas y auténticas. A través de nuestro modelo de
                    comercio justo,
                    las mujeres reciben un pago justo por su trabajo, lo que les permite mejorar la calidad de vida de
                    sus familias.
                </p>
                <p>
                    Además, trabajamos con técnicas ancestrales de tejido, lo que le da a cada prenda un toque único que
                    la
                    convierte en una pieza especial. Desde el diseño hasta la entrega, cada producto refleja nuestra
                    pasión por
